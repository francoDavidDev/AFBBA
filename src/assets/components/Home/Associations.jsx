...
const AssociationsCard = ({ experience }) => {
  return (
    <VerticalTimelineElement
      ...
      icon={
        <div className='flex justify-center rounded-full items-center w-full h-full bg-cover bg-no-repeat bg-center'
    ...
    >
      ...
      <ul className='mt-5 list-disc ml-5 space-y-2'>
        {experience.instagram.map((point, index) => (
          ...
          >
            <a href= {point} target="_blank">Intagram</a>
      ...
      <ul className='mt-5 list-disc ml-5 space-y-2'>
        {experience.web.map((point, index) => (
          <li
            ...
            className='text-white-100 text-[14px] pl-1 tracking-wider'
          >
            <a href= {point} target="_blank">Pagina Web</a>
