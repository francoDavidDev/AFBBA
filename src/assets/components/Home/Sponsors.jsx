    ...
    <section className="banner mb-20">
      <div className="slider-container">
        <div className="slider">
          <a href='https://www.veesfitness.com.ar/' target="_blank" className="item" style={{ '--position': 1 }}><img src={vees} alt="Vees Fitness" /></a>
          ...
          <a href='https://www.veesfitness.com.ar/' target="_blank" className="item" style={{ '--position': 5 }}><img src={vees} alt="Vees Fitness" /></a>
