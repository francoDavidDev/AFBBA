export const COURSES_DATA = [
  {
    id: 1,
    title: "Curso de Atletismo",
    description: "Mejora tu velocidad y resistencia con nuestro curso intensivo de atletismo. Este curso está diseñado para corredores de todos los niveles que desean perfeccionar su técnica y mejorar su rendimiento. Cubrimos desde ejercicios básicos hasta técnicas avanzadas de sprint y resistencia, incluyendo planes de entrenamiento personalizados.",
    category: "Atletismo",
    price: "$150",
    duration: "4 semanas",
  ...
  {
    id: 2,
    title: "Curso de Natación",
    description: "Desarrolla técnicas de nado eficientes y mejora tu resistencia en el agua con nuestro curso de natación. Este curso cubre todos los estilos de nado, técnicas de respiración y estrategias para mejorar tu rendimiento en la piscina. Ideal tanto para principiantes como para nadadores experimentados que buscan afinar sus habilidades.",
    category: "Natación",
    price: "$120",
    duration: "6 semanas",
  ...
  {
    id: 3,
    title: "Curso de Ciclismo",
    description: "Aumenta tu resistencia y técnica en bicicleta con nuestro curso de ciclismo. En este curso abordamos entrenamiento en carretera y técnicas de ciclismo en montaña. Aprenderás estrategias para mejorar tu rendimiento, así como ejercicios específicos para fortalecer tu cuerpo y aumentar tu resistencia.",
    category: "Ciclismo",
    price: "$180",
    duration: "5 semanas",
  ...
  },
  {
    id: 4,
    title: "Curso de Yoga",
    description: "Relaja tu cuerpo y mente con nuestro curso de Yoga. A través de prácticas de meditación y posturas de yoga, este curso te ayudará a mejorar tu flexibilidad, reducir el estrés y aumentar tu bienestar general. Es apto para todos los niveles y se adapta a tus necesidades personales.",
    category: "Yoga",
    price: "$100",
    duration: "8 semanas",
  ...
  {
    id: 5,
    title: "Curso de Artes Marciales",
    description: "Aprende técnicas de defensa personal y combate con nuestro curso de artes marciales. El curso abarca varias disciplinas, incluyendo karate y jiu-jitsu, y está diseñado para enseñarte habilidades de autodefensa y técnicas de combate en un entorno seguro y controlado.",
  ...
  {
    id: 6,
    title: "Curso de CrossFit",
    description: "Entrena con alta intensidad en nuestro curso de CrossFit. Este curso está diseñado para mejorar tu fuerza, resistencia y agilidad a través de una variedad de ejercicios funcionales y entrenamiento de alta intensidad. Se adaptará a tus capacidades y te ayudará a alcanzar tus objetivos de fitness.",
    category: "CrossFit",
    price: "$170",
    duration: "6 semanas",
  ...
  },
  {
    ...
    description: "Fortalece tu core y mejora tu flexibilidad con nuestro curso de Pilates. Este curso se centra en ejercicios de bajo impacto que ayudan a mejorar la postura, la fuerza del núcleo y la flexibilidad general. Es ideal para personas que buscan un enfoque más suave en su entrenamiento físico.",
    category: "Pilates",
    price: "$130",
    duration: "7 semanas",
